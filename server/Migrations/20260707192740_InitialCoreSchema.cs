        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaterMl = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaloriesPer100 = table.Column<double>(type: "double precision", nullable: false),
                    ProteinPer100 = table.Column<double>(type: "double precision", nullable: false),
                    FatPer100 = table.Column<double>(type: "double precision", nullable: false),
                    CarbsPer100 = table.Column<double>(type: "double precision", nullable: false),
                    SugarPer100 = table.Column<double>(type: "double precision", nullable: true),
                    FiberPer100 = table.Column<double>(type: "double precision", nullable: true),
                    IronMgPer100 = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseCycleMode = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductStocks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Calories = table.Column<double>(type: "double precision", nullable: true),
                    Sugar = table.Column<double>(type: "double precision", nullable: true),
                    CaffeineMg = table.Column<double>(type: "double precision", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DrinkEntries_ProductStocks_ProductStockId",
                        column: x => x.ProductStockId,
                        principalTable: "ProductStocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_DrinkEntries_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodEntries_ProductStocks_ProductStockId",
                        column: x => x.ProductStockId,
                        principalTable: "ProductStocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrinkEntries_ProductId",
                table: "DrinkEntries",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinkEntries_ProductStockId",
                table: "DrinkEntries",
                column: "ProductStockId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinkEntries_UserId_Date",
                table: "DrinkEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodEntries_ProductStockId",
                table: "FoodEntries",
                column: "ProductStockId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_Type_Name",
